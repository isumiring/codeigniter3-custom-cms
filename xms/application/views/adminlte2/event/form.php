            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="location" id="location" value="<?php echo (isset($post['location'])) ? $post['location'] : ''; ?>" required="required"/>
                    </div>
                    <?php if ($locales): ?>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group datetime datetimepicker" id="end_date_time">
                            <input type="text" class="form-control" name="end_date" id="end_date" value="<?php echo (isset($post['end_date'])) ? $post['end_date'] : ''; ?>" readonly="readonly"/>
