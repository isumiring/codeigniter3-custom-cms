                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control selectpicker" name="id_article_category" id="id_article_category" data-live-search="true" title='Choose one of the following...'>
                                    <?php foreach ($categories as $row => $category): ?>
                                        <option value="<?php echo $category['id_category']; ?>" <?php echo (isset($post['id_article_category']) && $post['id_article_category'] == $category['id_category']) ? 'selected="selected"' : ''; ?>><?php echo $category['title']; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <?php if ($locales): ?>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    <input type="text" class="form-control" name="publish_date" id="publish_date" value="<?php echo (isset($post['publish_date'])) ? $post['publish_date'] : date('Y-m-d'); ?>" readonly="readonly"/>
