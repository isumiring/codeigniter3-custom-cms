        ...
        if ($this->input->post()) {
            ...
            if ($this->validateForm($id)) {
                ...
                if ($post_image['mobile_image']['tmp_name']) {
                    ...
                    $this->Slideshow_model->UpdateRecord($id,array('mobile_image'=>$picture_db));
                }
                if ($post_image['video']['tmp_name']) {
                    ...
                    $this->Slideshow_model->UpdateRecord($id,array('video'=>$picture_db));
                }
                if ($post_image['video_mobile_1']['tmp_name']) {
                    ...
                    $this->Slideshow_model->UpdateRecord($id,array('video_mobile_1'=>$picture_db));
                }
                if ($post_image['video_mobile_2']['tmp_name']) {
                    ...
                    $this->Slideshow_model->UpdateRecord($id,array('video_mobile_2'=>$picture_db));
                }
                // insert to log
                $data_log = array(
                    'id_user' => id_auth_user(),
