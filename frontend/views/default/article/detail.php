...
<div class="container">
    ...
    <div class="row">
        <div class="side-left-col col-lg-8">
            <hr>

            <!-- Date/Time -->
            <p><i class="fa fa-clock-o"></i> <?php echo get_lang_text('general', 'general_text_post_date'); ?> <?php echo custom_date_format($article['publish_date'], 'd M Y'); ?></p>

            <hr>
            <?php if ($article['primary_image'] != '' && file_exists(UPLOAD_DIR. 'article/'. $article['primary_image'])): ?>
            <img class="img-responsive" src="<?php echo RELATIVE_UPLOAD_DIR. 'article/'. $article['primary_image']; ?>" alt="">
            <?php endif; ?>
