...
class Admin extends CI_Controller {
    ...
    public function list_data() {
        ...
        if ($this->input->post() && $this->input->is_ajax_request()) {
            ...
            $records = $this->Admin_model->GetAllAdminData($searchq,$order_by,$start,$perpage);
            $return = array();
            ...
            foreach ($records as $row => $record) {
                ...
                $return['data'][$row]['created'] = custDateFormat($record['create_date'],'d M Y H:i:s');
            }
                        ...
                        if ($record) {
                            if ($id == id_auth_user()) {
                                ...
                                if (is_superadmin()) {
                                    ...
                                    // end insert to log
                                    $this->session->set_flashdata('success_msg',get_lang_key('msg_success_delete_data_text'));
                                } else {
