    ...
    <head>
        ...
        <script type="text/javascript">
            tinymce.init({
                ...
                relative_urls: false,
                toolbar1: "undo redo | styleselect | bold italic | link image | alignleft aligncenter alignright | charmap code",
                toolbar2: "| responsivefilemanager | link unlink anchor | image media | forecolor backcolor  | print preview code ",
                image_advtab: true,
                external_filemanager_path: "<?php echo PATH_CMS; ?>assets/default/vendor/filemanager/",
                filemanager_title: "Filemanager",
                external_plugins: { "filemanager" : "<?php echo PATH_CMS; ?>assets/default/vendor/filemanager/plugin.min.js"},
                paste_as_text: true
            });
        </script>
                                ...
                                <ul class="dropdown-menu">
                                    <li class="user-header">
                                        ...
                                        <p>
                                            ...
                                            <small>Member since: <?php echo custom_date_format($user_data['create_date'], 'F, Y'); ?></small>
                                            <small>Last login: <?php echo custom_date_format($ADM_SESSION['admin_last_login'], 'd-m-Y H:i'); ?></small>
                                        </p>
                                    </li>
                                    <!-- Menu Footer-->
