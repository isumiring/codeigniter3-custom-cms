                ...
                <div class="col-md-8">
                    ...
                    <div class="">
                        ...
                        <label class="radio-inline">
                            <input type="radio" name="page_type" class="required iCheckBox" id="static_page" value="static_page" <?php echo (isset($post['page_type']) && $post['page_type'] == 'static_page') ? 'checked="checked"' : ''; ?> /> Static Page
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="page_type" class="required iCheckBox" id="module" value="module" <?php echo (isset($post['page_type']) && $post['page_type'] == 'module') ? 'checked="checked"' : ''; ?> /> Module
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="page_type" class="required iCheckBox" id="ext_link" value="ext_link" <?php echo (isset($post['page_type']) && $post['page_type'] == 'ext_link') ? 'checked="checked"' : ''; ?> /> External URL
                        </label>
                    </div>
