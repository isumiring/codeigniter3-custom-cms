...
define('IMG_ARTICLE_THUMB_WIDTH', 400);
define('IMG_ARTICLE_THUMB_HEIGHT', 400);
define('IMG_ARTICLE_PRIMARY_WIDTH', 800);
define('IMG_ARTICLE_PRIMARY_HEIGHT', 200);
